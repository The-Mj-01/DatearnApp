...
type SocialMediaRepositoryInterface interface {
	...
	DeleteSocialMedia(socialMedia *SocialMedia) (*SocialMedia, error)
}
...
type SocialMediaServiceInterface interface {
	...
	DeleteSocialMedia(socialId *uint) (*SocialMedia, error)
}
...
type SocialMediaUseCaseInterface interface {
	...
	DeleteSocialMedia(ctx context.Context, token string, request *SocialMediaDeleteRequest) (*SocialMedia, error)
}
